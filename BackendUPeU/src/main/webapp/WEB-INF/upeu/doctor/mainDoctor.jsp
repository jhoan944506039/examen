...
<html>
  ...
  <body  class="ng-cloak">
      <div class="generic-container" ng-controller="UserController as ctrl">
        ...
        <td>            
            <input  type="button" value="Nuevo" onclick="document.location.href='/BackendUPeU/doctor/formDoctor'" class="btn btn-success" >&nbsp; 
        </td>
              ...
              <div class="tablecontainer">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="editarDoctor?id=${dato.idDoctor}">Editar</a>&emsp14;
                    </td>
                </tr>
                </c:forEach>
                            </table>
