...
<html>
  ...
  <body  class="ng-cloak">
      <div class="generic-container" ng-controller="UserController as ctrl">
        ...
        <form  id="formBuscar" action="buscarPaciente"  method="post" name="formBuscar" >
        ...
        <td>
            <input  type="button" value="Nuevo" onclick="document.location.href='/BackendUPeU/formPaciente'" class="btn btn-success" >&nbsp;   
        </td>
        </tr>
        </table>
        </form>
          ...
          <div class="panel panel-default">
              ...
              <div class="tablecontainer">
                ...
                <c:forEach items="${ListaPciente}" var= "dato">   
                <tr>
                    ...
                    <td>
                        <a href="eliminarPaciente?id=${dato.idPaciente}">Eliminar</a>&emsp14;                                        
                    </td>
                </tr>
                </c:forEach>
                            </table>
